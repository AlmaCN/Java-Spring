...
* The original package name 'co.develhope.Deploy-Environments Variables 01' is invalid and this project uses 'co.develhope.DeployEnvironments.Variables1' instead.
