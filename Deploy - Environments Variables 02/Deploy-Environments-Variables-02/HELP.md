...
* The original package name 'co.develhope.Deploy-Environments Variables 02' is invalid and this project uses 'co.develhope.DeployEnvironments.Variables2' instead.
